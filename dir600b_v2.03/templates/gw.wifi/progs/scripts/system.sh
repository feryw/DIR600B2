...
start)
	...
	if [ -f /etc/templates/llmnresp.sh ]; then
	echo "start llmnresp daemon ..."
	/etc/templates/llmnresp.sh start > /dev/console
	fi
...
stop)
	...
	if [ -f /etc/templates/llmnresp.sh ]; then
	echo "stop llmnresp daemon ..."
	/etc/templates/llmnresp.sh stop > /dev/console
	fi
