...
stop)
	...
	;;
flushall|macfilter|ipfilter|firewall|vrtsrv|dmz|passthrough|misc|portt|lanchange|wanup|blocking|arp_attack|policy|flowmeter)
...
*)
	...
	echo "              arp_attack|policy|flowmeter]" > /dev/console
	;;
esac
