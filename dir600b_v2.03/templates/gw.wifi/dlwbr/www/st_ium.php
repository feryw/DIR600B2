		...
		<div name="show_tcnotify" id="show_tcnotify" class="box" style="display:none">
			...
			<tr>
				...
				<td class="l_tb">&nbsp;
					...
					<input name="down_limit" type="text" id="down_limit" size="10" maxlength="32" value="<?=$cfg_downlimit?>"><?=$m_mbytes?>
				</td>
			</tr>
			<tr>
				...
				<td class="l_tb">&nbsp;
					...
					<input name="up_limit" type="text" id="up_limit" size="10" maxlength="32" value="<?=$cfg_uplimit?>"><?=$m_mbytes?>
				</td>
			</tr>
			</table>
			<table cellpadding="1" cellspacing="1" border="0" width="525">
			...
			<tr>
				...
				<td class="l_tb">&nbsp;
					<input name="down_threshold" type="text" id="down_threshold" size="10" maxlength="32" 
			...
			<tr>
				...
				<td class="l_tb">&nbsp;
					<input name="up_threshold" type="text" id="up_threshold" size="10" maxlength="32" 
			...
			<div align=right><a href="/tools_log_setting.php">Email Settings</a></div>
			</div>
		</div>
