...
<strong><em>Datenverkehrstyp </em></strong> - Protokoll, das für die Anwendung verwendet wird. </td>
 ...
 Die Funktion 'QoS-Engine' hilft dabei, durch Bevorzugung von Anwendungen Ihre Netzwerkleistung zu verbessern.<br>

<strong>QoS-Engine-Setup</strong><br>
<strong><em>QoS-Engine aktivieren</em></strong> - Aktivieren Sie diese Option für mehr Leistung und Spaß bei Online-Spielen und anderen interaktiven Anwendungen wie VoIP.<br>
<strong><em>Automatische Uplink-Geschwindigkeit</em></strong> - Ist diese Einstellung aktiviert, ermittelt der Router bei jeder Initialisierung der WAN-Schnittstelle (z. B. bei einem Neustart) automatisch die verfügbare Uplink-Bandbreite.<br>
<strong><em>Gemessene Uplink-Geschwindigkeit</em></strong> - Gemessene Uplink-Geschwindigkeit bei der letzten Initialisierung der WAN-Schnittstelle. Der Wert kann etwas niedriger als der von Ihrem Internetdienstanbieter angegebene Wert sein, weil nicht alle Netzwerkprotokoll-Overheads darin eingeschlossen sind. Der Wert beträgt bei xDSL in der Regel zwischen 87 % und 91 % der angegebenen Uplink-Geschwindigkeit und bei Kabelnetzwerk-Verbindungen etwa 5 kbps weniger als die angegebene Uplink-Geschwindigkeit. <br>
<strong><em>Manuelle Uplink Geschwindigkeit</em></strong> - Wenn automatische Uplink Geschwindigkeit deaktiviert ist, kann diese manuell eingestellt werden. Uplink Geschwindigkeit ist die Geschwindigkeit, mit der Daten vom Router an Ihren Internetdienstanbieter übertragen werden können. Sie wird durch Ihr Internetdienstanbieter festgelegt. Internetdienstanbieter spezifizieren häufig Geschwindigkeit als Downlink/Uplink Paar; z.B. 1.5Mbit/s zu 284Kbit/s. Für dieses Beispiel würden Sie „284“ eintragen. Alternativ können Sie Ihre Uplink Geschwindigkeit mit einem Service wie www.dslreports.com testen. Beachten Sie jedoch, dass Seiten wie DSL-Reports, weil sie Netzwerksprotokoll Overhead nicht berücksichtigen, im Allgemeinen etwas niedrigere Werte messen, als die Internetdienstanbieter angeben.<br>
<strong><em>Verbindungstyp</em></strong> - In der Werkseinstellung stellt der Router automatisch fest, ob die zugrunde liegende Verbindung einem xDSL/Frame-Relay Netzwerk oder einem anderen Verbindungstyp (wie Kabel Modem oder Ethernet) entspricht und er zeigt das Resultat wie xDSL oder Frame-Relay Netzwerk erkanntan. Wenn Sie eine spezielle Netzwerk Verbindung haben, in der Sie über xDSL angeschlossen werden, aber für die Sie entweder „Statisch“ oder „DHCP“ in den WAN Einstellungen konfiguriert haben, stellt die Einstellung der Option auf  xDSL oder anderen Frame-Relay Netzwerk sicher, dass der Router erkennt, dass er den Verkehr etwas anders einstellen muss, um die Beste Leistung zu erreichen. Die Auswahl von xDSL oder anderes Frame-Relay Netzwerk zeigt die gemessene Uplink Geschwindigkeit etwas niedriger an als vorher, aber es werden viel Bessere Resultate erzielt.<br>
<strong><em>xDSL oder Frame Relay Netzwerk entdeckt</em></strong> - Wenn Verbingdungstyp auf Automatische Erkennung eingestellt ist, wird der automatisch erkannte Verbindungstyp hier angezeigt.<br>
 </td>
 </tr>
 <?if(query("/runtime/func/qos_engine")!="1"){echo "-->\n";}?>
 <tr>
...
{
 echo "<p><strong><em>Funkmodus - </em></strong>Wenn alle drahtlosen Geräte, die Sie an diesen Router anschließen möchten, im gleichen Übertragungsmodus arbeiten, können Sie die Leistung verbessern, indem Sie den passenden „Nur“ Modus wählen. Wenn Sie einige Geräte haben, die einen anderen Übertragungsmodus verwenden, wählen Sie den passenden „Gemischt“ Modus.</p>";
 echo "<p><strong><em>Bandbreite - </em></strong>Die „Auto 20/40 MHz“ Option ist normalerweise am besten. Die anderen Optionen sind für spezielle Umstände vorgesehen.</p>";
 echo "<p><strong><em>Kurzes Guard Interval - </em></strong>Das Verwenden eines kurzen (400ns) „Guard“ Intervalls kann den Durchsatz erhöhen. Die Fehlerhäufigkeit kann aber wegen der erhöhten Empfindlichkeit für Hochfrequenzreflexionen in manchen Installationen etwas zunehmen. Wählen Sie die Option aus, die in Ihrer Installation am besten funktioniert.</p>";
}
?>
...
-->
 <p><strong>Multicast</strong><br>Aktivieren Sie diese Option, um einen effektiveren Multicast-Datenverkehr vom Internet zu Ihrem Netzwerk zu erreichen. </p> </td>
 </tr>
