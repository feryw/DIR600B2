...
<tr>
	<td height=20>
		<p>
			...
			Netzwerk autorisiert und authentifiziert. WPA/WPA2 ist sicherer als WEP und basiert auf einem Schlüssel, der sich in 
			regelmäßigen Abständen automatisch ändert.
		</p>
		<p>
			<strong><em>Verschlüsselungstyp</em></strong> -
			Bei Verwendung von WPA/WPA2 unterstützt der <?query("/sys/modelname");?> zwei verschiedene Verschlüsselungstypen: 
			...
			Dieses Mittel zur WPA/WPA2-Authentifizierung wird in Verbindung mit einem RADIUS-Server verwendet, 
			der sich in Ihrem Netzwerk befinden muss. Geben Sie die IP-Adresse, den Port und den gemeinsamen geheimen Schlüssel ein, 
			für die der RADIUS-Server in Ihrem Netzwerk konfiguriert ist. Für den Fall, dass sich in Ihrem Netzwerk zwei 
			RADIUS-Server zur Authentifizierung der drahtlosen Clients befinden, haben Sie die Möglichkeit, 
			auch die Informationen für den zweiten RADIUS-Server einzugeben.
		</p>
	</td>
</tr>
<tr><td height=20>&nbsp;</td></tr>
