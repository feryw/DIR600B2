...
-->		<p>
		...
		<p>
			<strong><em>Aktivieren Grafische Authentifizierung</em></strong> -
			Durch Einschalten der Grafikauthentifizierung (CAPTCHA) wird ein Abfrage/Antwort-Test mit dem Bild verzerrter Zeichen auf der Anmeldeseite aktiviert. Diese Sicherheitsfunktion kann verhindern, dass Malware-Programme und Hacker Zugriff auf Ihren Router erlangen.
		</p>
		<p>
		...
		<p>
			<strong><em>Beispiel:  </em></strong><br>http://x.x.x.x:8080 </a> wobei x.x.x.x die WAN-IP-Adresse des
			 <?query("/sys/modelname");?> und 8080 der Port für die Webverwaltungsoberfläche sind. 
		</p>
	</td>
</tr>
...
<tr>
	<td>
		<p>
			...
			<strong><em>Protokollebene</em></strong> - Wählen Sie, welche Informationen der <?query("/sys/modelname");?> protokollieren soll.
		</p>
	</td>
</tr>
