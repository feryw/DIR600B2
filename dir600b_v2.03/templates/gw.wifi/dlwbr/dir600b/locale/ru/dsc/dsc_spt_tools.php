...
<tr>
	<td>
		<p>
            ...
            <strong><em>Тип события</em></strong> -  Выберите тип информации для записи в журнал <?query("/sys/modelname");?>.<br>
            <strong><em>Уровень события</em></strong> -  Выберите уровень информации для записи в журнал <?query("/sys/modelname");?>.
