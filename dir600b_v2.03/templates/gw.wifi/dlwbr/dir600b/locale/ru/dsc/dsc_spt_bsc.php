...
<tr>
	<td height=20>
		<p>
			...
			Протокол WPA/WPA2 обеспечивает большую степень безопасности, чем WEP.
			Протокол WPA/WPA2 использует ключ, автоматически изменяемый через определенный интервал.
		</p>
		<p>
			<strong><em>Тип шифра</em></strong> -
			<?query("/sys/modelname");?> поддерживает два типа шифров при использовании WPA/WPA2.
			...
			При выборе данной опции аутентификация WPA/WPA2 используется в связке с RADIUS-сервером, который должен быть представлен в сети.
