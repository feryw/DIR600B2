...
<tr>
	<td height=20>
		...
		<p>
			...
			http://x.x.x.x:8080 où x.x.x.x est l'adresse IP WAN 
...
<tr>
	<td>
		<p>
			...
			<strong><em>Niveau de journal</em></strong> - Sélectionnez le Niveau d'informations que vous souhaitez que le <?query("/sys/modelname");?> enregistre.
		</p>
	</td>
</tr>
