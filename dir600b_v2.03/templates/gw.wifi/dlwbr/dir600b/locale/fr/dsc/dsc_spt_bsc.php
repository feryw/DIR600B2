...
<tr>
	<td height=20>
		<p>
			...
			le réseau sans fil.Le mode WPA/WPA2 offre une sécurité supérieure au WEP et est fondé sur une clé modifiée 
			automatiquement, à intervalles réguliers.
		</p>
		<p>
			<strong><em>Type de chiffrement</em></strong> -
			Le <?query("/sys/modelname");?> prend en charge deux types de chiffrement différents avec le type de sécurité WPA/WPA2.
			...
			Cela signifie que l'authentification WPA/WPA2 est associée à un serveur RADIUS qui doit se trouver sur votre réseau.
