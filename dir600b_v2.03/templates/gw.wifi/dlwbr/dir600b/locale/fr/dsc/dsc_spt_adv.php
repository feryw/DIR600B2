...
<strong><em>Type de trafic </em></strong> - Le protocole utilisé pour l'application. </td>
 ...
 Grâce à la fonction de moteur QoS, vous pouvez améliorer les performances réseau en définissant des priorités pour les applications.<br>

<strong>Configuration du moteur QoS</strong><br>
<strong><em>Activer le moteur QoS</em></strong> - Utilisez cette technologie pour obtenir de meilleures performances avec des jeux en ligne ou dautres applications interactives (VoIP, etc.). <br>
<strong><em>Vitesse automatique de liaison montante</em></strong> - Lorsqu’elle est activée, cette option oblige le routeur à mesurer automatiquement la bande passante utile en liaison montante chaque fois que l'interface du réseau étendu est rétablie (par exemple après une réinitialisation). <br>
<strong><em>Vitesse de liaison montante mesurée</em></strong> - Il s'agit de la vitesse de liaison montante mesurée lorsque l'interface du réseau étendu a été rétablie pour la dernière fois. Sa valeur peut être inférieure à celle annoncée par votre FAI, car elle n'inclut pas tous les temps système des protocoles associés au réseau de votre FAI. Généralement, cette valeur est comprise entre 87 % et 91 % de la vitesse de liaison montante définie pour les connexions xDSL, et est inférieure d’environ 5 kbits/s pour les connexions par câble. <br>
<strong><em>Vitesse manuelle de liaison montante</em></strong> - Si la vitesse automatique de liaison montante est désactivée, cette option vous permet de la régler manuellement. La vitesse de liaison montante est la vitesse à laquelle des données peuvent être transférées à partir du routeur vers votre FAI (Fournisseur d’Accès à Internet). Ceci est déterminé par votre FAI. La vitesse est souvent la indiquée comme une paire de liaison descendante/liaison montante ; par exemple, 1.5Mbps/284kbps. En suivant cet exemple, vous devrez saisir "284". Vous pouvez aussi examiner la vitesse de liaison montante à l’aide d’un service comme www.dslreports.com. Notez cependant que les sites tel DSL Reports, parce qu'ils ne gèrent pas tous les protocoles réseau, indiqueront généralement des vitesses légèrement inférieures à la vitesse mesurée réelle ou à la vitesse indiquée par le FAI. <br> 
<strong><em>Type de connexion</em></strong> - Par défaut, le routeur examine automatiquement si la connexion est en réseau xDSL/Relais de trames ou un autre type (tel que le modem câble ou l'Ethernet), et il montre le résultat comme <strong> xDSL ou Relais de trames réseau</strong>. Si votre connexion à Internet est xDSL mais avec une configuration IP WAN est "Statique" ou le "DHCP", réglez cette option dans<strong> xDSL ou Rélais de trames réseau </strong> afin que le routeur puisse se connecter correctement et donner les meilleures performances. Sélectionnez <strong>xDSL ou Relais de trames réseau</strong> implique que la vitesse mesurée de liaison montante peut être légèrement plus lente que la connexion antérieure, mais qu’elle donne de meilleurs résultats.
<br>
<strong><em>Détection xDSL ou Relais de trames réseau</em></strong> - Lorsque <strong>Type de connexion</strong> est réglé à <strong>Auto-détection</strong>, le type de connexion automatiquement détecté est affiché ici. 
<br>
 </td>
 </tr>
 <?if(query("/runtime/func/qos_engine")!="1"){echo "-->\n";}?>
...
<tr>
	<td height=99>
		<p>
			<a name=07><strong>Filtres MAC</strong></a><br>
		...
		<p>
			...
			précédemment définie ou cliquez sur le bouton <strong>Nouveau calendrier</strong> pour ajouter une nouvelle 				programmation.
		</p>
		<p>
...
  			ou une plage d'adresses IP en saisissant la première adresse IP de la plage dans la zone supérieure et
			...
			définie ou cliquez sur le bouton <strong>Nouveau calendrier</strong> pour ajouter une nouvelle programmation.
 </p>
	</div></td>
</tr>
<tr><td height=20>&nbsp;</td></tr>
