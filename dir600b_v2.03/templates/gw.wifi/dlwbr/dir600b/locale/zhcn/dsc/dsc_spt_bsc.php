...
<tr>
	<td height=20>
		<p>
			<strong>俄罗斯 PPTP(双重访问)</strong><br>
			如配置一条俄罗斯 PPTP Internet连接，可按照先前描述的PPTP连接进行配置。
			如果您的ISP要求设置任何静态路由，请参考&quot;高级&quot;菜单中的&quot;路由选择&quot;功能来获得详细的设置信息。
		</p>
	</td>
</tr>
<tr><td height=20>&nbsp;</td></tr>
<tr>
	<td height=20>
		<p>
			<strong>俄罗斯 PPPoE(双重访问)</strong><br>
			某些PPPoE连接采用了静态IP路由连接到ISP，采用全局IP设置连接的除外。由此要求添加一个步骤，
			用于物理WAN端口的IP设置。如要配置一条俄罗斯 PPPoE Internet连接，可按照先前描述的PPPoE连接进行配置，
			并按照ISP的指导添加物理WAN IP设置。
			如果您的ISP要求设置静态路由，请参考&quot;高级&quot;菜单中的&quot;路由选择&quot;功能来获取详细设置信息。
		</p>
	</td>
</tr>
<tr><td height=20>&nbsp;</td></tr>
...
<tr>
	<td height=20>
		<p>
			...
			WPA/WPA2使用了比WEP更强的安全机制，它基于在一个常规时间间隔自动改变的密钥。
		</p>
		<p>
			<strong><em>密码类型</em></strong> -
			当WPA/WPA2被用作安全类型时，<?query("/sys/modelname");?>支持两种不同类型的密码类型。
			...
			这意味着WPA/WPA2认证也可以和您网络上存在的RADIUS服务器协同使用。
