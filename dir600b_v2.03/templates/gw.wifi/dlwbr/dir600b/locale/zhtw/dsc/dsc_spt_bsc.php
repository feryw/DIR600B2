...
<tr>
	<td height=20>
		<p>
			...
			當設定Russian PPTP 網際網路連線,請將ISP業者所提供的訊息進行PPTP的連線組態設定。
			假如靜態路由設定需要由您的ISP業者協助,敬請參考 &quot;Routing&quot; 功能在 &quot;ADVANCED&quot; 目錄中的進階設定。
		</p>
	</td>
</tr>
<tr><td height=20>&nbsp;</td></tr>
<tr>
	<td height=20>
		<p>
			...
			有些PPPoE 連線是使用靜態IP路由至ISP業者的整體IP設定進行連線。本要求為定義WAN端介面的IP設定。
			當設定Russian PPPoE 網際網路連線,如上述說明將PPPoE 設定ISP業者所提供給您的WAN端介面設定。
			假如靜態路由設定需要由您的ISP業者協助,敬請參考 &quot;Routing&quot; 功能在 &quot;ADVANCED&quot; 目錄中的進階設定。
		</p>
	</td>
</tr>
...
<tr>
	<td height=20>
		<p>
			...
			WPA/WPA2提供無線網路使用者存取之授權予認證。WPA/WPA2提供使用者比WEP更加安全的無線加密，
			主要透過定時的自動改變鑰匙提高安全性。
		</p>
		<p>
			...
			802.1x的意思為在您的網路環境中若是用WPA/WPA2認證必須結合RADIUS 伺服器。輸入IP位址,服務埠,與您Radius組態
