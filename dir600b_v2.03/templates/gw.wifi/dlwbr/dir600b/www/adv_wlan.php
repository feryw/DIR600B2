...
$has_partition = query("/runtime/func/wlan_partition");
if ($ACTION_POST!="")
{
	...
	if($has_partition=="1")
	{
	if($partition=="1") {$wlan2wlan="0";} else {$wlan2wlan="1";} 
	if(query("bridge/wlan2wlan") !=$wlan2wlan)		{set("bridge/wlan2wlan",	$wlan2wlan);	$db_dirty++;}
/*	
	{
		if($partition=="1"){set("bridge/wlan2wlan","0");} else {set("bridge/wlan2wlan","1");}
		$db_dirty++;
	}
*/
	}
...
$wlan2wlan	=query("bridge/wlan2wlan");
if($wlan2wlan=="") {$wlan2wlan="1";}
if($support11n=="1")
{
...
<?
	...
	if($has_partition=="1")
	{
	echo "f.partition.checked = ";
	if($wlan2wlan=="1") {echo "false;";} else {echo "true;";}
	echo "\n";
	}
?>
...
function check()
{
	...
	if($has_partition=="1")
	{
		echo "f.partition.value=f.partition.checked?1:0;\n";
	}
	?>
...
<!-- ________________________________ Main Content Start ______________________________ -->
		<div class="box">
			...
			<?if($has_partition!="1"){echo "<!--\n";}?>
			<tr>
				<td class=r_tb><?=$m_partition?> :</td>
				<td>
				<input type=checkbox name=partition id=partition value=0 >
				</td>
			</tr>
			<?if($has_partition!="1"){echo "-->\n";}?>
			<tr>
