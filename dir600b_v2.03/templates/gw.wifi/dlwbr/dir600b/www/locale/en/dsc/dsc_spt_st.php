...
<strong><em>Reset - </em></strong>Click this button to clear the counters. The traffic counter will reset when the device is rebooted. </td>
 ...
 Active Session displays Source and Destination packets passing through the <?query("/sys/modelname");?>. <br>
 ...
 Use this page in order to view how many wireless clients have associated with the <?query("/sys/modelname");?>. This page shows the MAC address of each associated client, how long they have been associated, and the mode they are connecting in (802.11b or 802.11g or 802.11n).
</td>
