...
<tr><td>
	...
	<?
	if( query("/runtime/func/qos_engine") == "1")
	{
		echo "<li><a href=";
		echo $spt_adv_url;
		echo "#01 target=_blank><font color=";
		echo $font_color.">".$m_menu_adv_qos."</font></a></li>\n";
	}
	?>
	...
	<?
	if( query("/runtime/func/policy") == "1")
	{
		echo "<li><a href=";
		echo $spt_adv_url;
		echo "#09 target=_blank><font color=";
		echo $font_color.">".$m_menu_adv_policy."</font></a></li>\n";
	}
	?>
	<li><a href=<?=$spt_adv_url?>#10 target=_blank><font color=<?=$font_color?>><?=$m_menu_adv_wlan?></font></a></li>
	<li><a href=<?=$spt_adv_url?>#11 target=_blank><font color=<?=$font_color?>><?=$m_menu_adv_network?></font></a></li>
	<?
	if( query("/runtime/func/dis_routing") != "1" )
	{
	echo "<li><a href=";
	echo $spt_adv_url;
	echo "#12 target=_blank><font color=";
