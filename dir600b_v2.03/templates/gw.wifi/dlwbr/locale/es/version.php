...
$m_context_title_mandatory="Obligatorio";
$m_context_title_optional="Opcional";
$m_firmware_external_version = "Versión externa de firmware:";
$m_firmware_internal_version = "Versión interna de firmware:";
$m_date = "Fecha:";
$m_checksum = "Suma de comprobación:";
$m_wlan_domain = "Dominio WLAN:";
$m_firmare_query = "Consulta de firmware:";
$m_system_uptime = "Tiempo de actividad del sistema";
$m_wan_mac = "WAN MAC: ";
$m_lan_mac = "LAN MAC: ";
$m_wlan_mac = "WLAN MAC: ";
...
$m_kernel = "Kérnel: ";
$m_ssid = "SSID: ";
$m_default_setting = "Configuración predeterminada: ";
$m_ssid = "SSID: ";
$m_svn = "SVN: ";
$m_debug_mode = "Modo de depuración: ";
$m_apps = "Apps: ";
$m_wlan_driver = "Unidad WLAN: ";
...
//$m_context = "版本 : ".$version_no."<br><br>Número de build : ".$build_no."<br><br>";
//$m_context = $m_context."Tiempo de actividad del sistema: <script>document.write(shortTime());</script>";
