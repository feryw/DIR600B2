...
#include "../../../include/elbox_config.h"	//jervis add
...
static void parse_inittab(void)
{
	...
	if (file == NULL) {
		...
		//run login instead of shell on 2690 platform. jervis 2009-7-3
#if	ELBOX_PROGS_PRIV_CLI_VER2		
		new_init_action(ASKFIRST, "/usr/sbin/login admin ''  -l/usr/sbin/cli -t3600 -cN ", "");
#else
