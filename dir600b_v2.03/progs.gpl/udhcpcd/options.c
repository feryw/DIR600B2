...
//+++ Ivor
	...
	{"sstrout",	OPTION_IP | OPTION_LIST | OPTION_REQ,		0x21},
#else
	{"sstrout",	OPTION_33 | OPTION_LIST | OPTION_REQ,		0x21},
#endif	
//--- Ivor
...
#else
	{"wins",		OPTION_IP | OPTION_LIST	| OPTION_REQ,	0x2c},
	{"winstype",	OPTION_U8 | OPTION_REQ,					0x2e},
...
//+++ Ivor
	...
	/* Add Classless Static Route Option, RFC 3442*/
	{"clsstrout",	OPTION_IP| OPTION_LIST | OPTION_REQ,		0x79},
#else
	{"clsstrout",	OPTION_121| OPTION_LIST | OPTION_REQ,		0x79},
#endif
//--- Ivor
	{"",			0x00,									0x00}
};
...
int option_lengths[] =
{
	...
	[OPTION_S32] =		4,
	[OPTION_33] =		8,
	[OPTION_121] =		0 	// 0: means dynamic length
	//--- Ivor
};
...
void attach_option(struct option_set **opt_list, struct dhcp_option *option, char *buffer, int length)
{
	...
	else
	{
		...
		curr = opt_list;
		while (*curr && (*curr)->data[OPT_CODE] < option->code) curr = &(*curr)->next;
