...
{
	rtnl_rtprot_init = 1;
	rtnl_tab_initialize("/var/etc/iproute2/rt_protos",
			    rtnl_rtprot_tab, 256);
}
...
static void rtnl_rtscope_initialize(void)
{
	...
	rtnl_tab_initialize("/var/etc/iproute2/rt_scopes",
...
{
	rtnl_rtrealm_init = 1;
	rtnl_tab_initialize("/var/etc/iproute2/rt_realms",
...
static void rtnl_rttable_initialize(void)
{
	...
	rtnl_tab_initialize("/var/etc/iproute2/rt_tables",
...
static void rtnl_rtdsfield_initialize(void)
{
	...
	rtnl_tab_initialize("/var/etc/iproute2/rt_dsfield",
