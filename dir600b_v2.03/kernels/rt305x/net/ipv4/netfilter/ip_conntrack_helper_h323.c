			   ...
			   H245_TransportAddress * addr)
{
	...
	rtp_exp->mask.src.ip = safe_calling_mode? htonl(0xFFFFFFFF) : 0;
	...
	rtcp_exp->mask.src.ip = safe_calling_mode? htonl(0xFFFFFFFF) : 0;
		       ...
		       H245_TransportAddress * addr)
{
	...
	exp->mask.src.ip = safe_calling_mode? htonl(0xFFFFFFFF) : 0;
