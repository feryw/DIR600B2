...
#if 1 //kwest add fro access control web access log
			...
			{ 
				...
				if (match_http_method(line) && match_http_version(line))
				{
					...
					else
					{
						...
						memset(uri_path, 0, MAX_URI_LEN);
						strncpy(uri_path, abs_path, MAX_URI_LEN);
