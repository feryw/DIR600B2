/*
** $Id: proslic_spi_api.c,v 1.1 2008-12-31 02:39:58 qwert Exp $
**
** spi.h
...
static uInt8 ReadReg (uInt16 portID, uInt8 channel, uInt8 regAddr)
{
	...
	*/
	...
	return spi_si321x_read8((unsigned char)(channel), (unsigned char)regAddr);
...
static void WriteReg (uInt16 portID, uInt8 channel, uInt8 regAddr, uInt8 data)
{
	...
	*/
	...
	spi_si321x_write8((unsigned char)(channel), (unsigned char)regAddr, data);
}
