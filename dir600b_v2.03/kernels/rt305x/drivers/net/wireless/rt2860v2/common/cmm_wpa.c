...
#endif // MESH_SUPPORT //
	{
		...
		IF_DEV_CONFIG_OPMODE_ON_STA(pAd)
		{
			...
			if (pAd->StaCfg.WpaSupplicantUP)
			{
				...
				if ((AuthMode != Ndis802_11AuthModeWPAPSK) && (AuthMode != Ndis802_11AuthModeWPA2PSK) && (AuthMode != Ndis802_11AuthModeWPANone))
					return;
...
#ifdef CONFIG_STA_SUPPORT
			IF_DEV_CONFIG_OPMODE_ON_STA(pAd)
			pRsnie = (RSNIE*)pAd->StaCfg.RSN_IE;
#endif // CONFIG_STA_SUPPORT //
		}
...
#ifdef CONFIG_STA_SUPPORT
			IF_DEV_CONFIG_OPMODE_ON_STA(pAd)
			pAd->StaCfg.RSNIE_Len = Rsnie_size + sizeof(RSNIE_AUTH) + sizeof(RSN_CAPABILITIES);
#endif // CONFIG_STA_SUPPORT //
		}
    }
...
#ifdef CONFIG_STA_SUPPORT
			IF_DEV_CONFIG_OPMODE_ON_STA(pAd)
				pRsnie2 = (RSNIE2*)pAd->StaCfg.RSN_IE;
#endif // CONFIG_STA_SUPPORT //
		}
...
#ifdef CONFIG_STA_SUPPORT
		IF_DEV_CONFIG_OPMODE_ON_STA(pAd)
		DBGPRINT(RT_DEBUG_TRACE,("RTMPMakeRSNIE in STA mode: RSNIE_Len = %d\n", pAd->StaCfg.RSNIE_Len));
#endif // CONFIG_STA_SUPPORT //
	}
}
