...
#define RADR_DONT_SWITCH	0x10 // Don't Switch channel when hit
	UCHAR McuRadarDebug;
...
{
	UCHAR        			BeaconBuf[MAX_MBSSID_NUM][HW_BEACON_OFFSET];
	UCHAR					BeaconTxWI[MAX_MBSSID_NUM][TXWI_SIZE];
	ULONG 					TimIELocationInBeacon[MAX_MBSSID_NUM];
	ULONG					CapabilityInfoLocationInBeacon[MAX_MBSSID_NUM];
